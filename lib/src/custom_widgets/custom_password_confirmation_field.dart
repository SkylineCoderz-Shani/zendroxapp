...
class CustomPasswordConfirmationField extends StatefulWidget {
  ...
  const CustomPasswordConfirmationField({
    Key? key,
...
class _CustomStyledTextFieldState extends State<CustomPasswordConfirmationField> {
  bool _isHidden = true;
